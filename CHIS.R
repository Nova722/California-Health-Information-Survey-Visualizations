...
# Age histogram, examined different bin widths
library(ggplot2)
ggplot(adult, aes(x = SRAGE_P)) +
  geom_histogram() +scale_x_continuous("age")

ggplot(adult, aes(x = SRAGE_P)) +
  geom_histogram(binwidth = 0.7) +scale_x_continuous("age")

# BMI value histogram
library(ggplot2)
ggplot(adult, aes(x = BMI_P)) +
  geom_histogram() +scale_x_continuous("BMI Value")

ggplot(adult, aes(x = BMI_P)) +
  geom_histogram(binwidth = 0.7) +scale_x_continuous("BMI Value")
